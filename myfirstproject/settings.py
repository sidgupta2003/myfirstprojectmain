...
SECRET_KEY = 'django-insecure-bj$b0%5b@-9pxza468@9yq*)3q39pp4191+)kr&4k52culpq%1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'custom_auth/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'mydjango',  # Replace with your database name
